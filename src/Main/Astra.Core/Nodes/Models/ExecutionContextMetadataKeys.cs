...
{
    public static class ExecutionContextMetadataKeys
    {
        public const string UiLogWriter = AstraSharedConstants.MetadataKeys.UiLogWriter;
        public const string RawDataStore = AstraSharedConstants.MetadataKeys.RawDataStore;
